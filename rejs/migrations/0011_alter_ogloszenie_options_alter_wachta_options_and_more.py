	...
	operations = [
		...
		migrations.AddField(
			...
			field=models.BooleanField(
				default=False,
				help_text="czy uczestniczyłeś/łaś w innych rejsach zobaczyć morze? zaznacz pole.",
		...
		migrations.AddField(
			...
			field=models.CharField(
				choices=[("ZALOGANT", "załogant"), ("OFICER-WACHTY", "oficer wachty")],
				default="ZALOGANT",
				max_length=25,
			),
		),
		...
		migrations.AlterField(
			...
			field=models.CharField(
				...
				default=("NOT_QUALIFIED", "Niezakwalifikowany"),
				max_length=20,
			),
		),
		migrations.AlterField(
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					"poz1",
					rejs.models.EncryptedTextField(default="12345678900", max_length=13, verbose_name="pesel"),
				),
				(
					"poz2",
					rejs.models.EncryptedTextField(
						choices=[
							("paszport", "paszport"),
							("dowod-osobisty", "dowód osobisty"),
						],
						default=("paszport", "paszport"),
						max_length=14,
				...
				(
					"poz3",
					rejs.models.EncryptedTextField(default="ABC123", verbose_name="numer dokumentu"),
				),
				(
					"zgloszenie",
